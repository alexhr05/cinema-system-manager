...
public:
	DocumentaryMovie(MyString title, int rate, double duration, int productYear, MyString Genre, int hallId, tm& timeInfo, int startHour, int endHour, MoviesType type, bool isBasedOnTrueEvents);
